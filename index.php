...
<body>
    <section class="congratulations">
        ...
        <p>Your AWS Elastic Beanstalk <em>PHP</em> application is now running on your own dedicated environment in the AZURE &nbsp;Cloud</p>
        <p>You are running PHP version <?= phpversion() ?></p>
	<p>This is v1 of the Azure Web App</p>
    </section>
